...
public static class Draw2D
{
	...
	public static void DrawLine(Vector2 pointA, Vector2 pointB, Color color, float width, bool antiAlias)
	{
		...
		pointA = GetPos(pointA);
		pointB = GetPos(pointB);
	...
	public static void DrawBezierLine(Vector2 start, Vector2 startTangent, Vector2 end, Vector2 endTangent, Color color, float width, bool antiAlias, int segments)
	{
		...
		for (int i = 1; i < segments + 1; ++i)
		{
			...
			Draw2D.DrawLine(lastV, v, color, width, antiAlias);
			lastV = v;
		}
	}
	...
	private static Vector3 GetPos(Vector3 imagePos) {
		var c = Camera.main.pixelHeight/2;
		return new Vector3(imagePos.x, (c - imagePos.y)+c);
	}
